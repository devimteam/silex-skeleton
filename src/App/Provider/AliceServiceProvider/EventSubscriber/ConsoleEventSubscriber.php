...
namespace App\Provider\AliceServiceProvider\EventSubscriber;

use App\Provider\AliceServiceProvider\Command\FixturesLoadCommand;
...
class ConsoleEventSubscriber implements EventSubscriberInterface
{
    ...
    public function onConsoleInit(ConsoleEvent $event)
    {
        ...
        $console->add(new FixturesLoadCommand());
    }
}
